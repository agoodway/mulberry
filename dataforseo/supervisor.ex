defmodule Listex.DataForSEO.Supervisor do
  @moduledoc """
  ...
  alias Listex.DataForSEO.{TaskRegistry, TaskManager}
  ...
  defp generate_task_id do
    ("dfs_" <> :crypto.strong_rand_bytes(16)) |> Base.url_encode64(padding: false)
  end
end

defmodule Mulberry.Document.YouTubePlaylist do
  ...
  defimpl Mulberry.Document do
    ...
    @spec generate_summary(YouTubePlaylist.t(), keyword()) :: {:ok, YouTubePlaylist.t()} | {:error, any(), YouTubePlaylist.t()}
    ...
    @spec generate_keywords(YouTubePlaylist.t(), keyword()) :: {:ok, YouTubePlaylist.t()} | {:error, any(), YouTubePlaylist.t()}
    ...
    @spec generate_title(YouTubePlaylist.t(), keyword()) :: {:ok, YouTubePlaylist.t()} | {:error, any(), YouTubePlaylist.t()}
    ...
    @spec to_chunks(YouTubePlaylist.t(), keyword()) :: {:ok, [TextChunker.Chunk.t()]} | {:error, any()}
